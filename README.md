...
| 이름 | 역할 | 담당 업무 |
|------|------|----------|
| 김나연 | 팀장/데이터 분석 | EDA 및 데이터 전처리 |
| 박범수 | 모델링 | XGBoost 및 ResNet 모델 개발 |
| 양예승 | 대시보드 | Streamlit UI/UX 설계 |
| 이근혁 | 백엔드 | 모델 추론 및 전략 엔진 |
| 최현우 | 프로젝트 관리 | 일정 조율 및 문서화 |
...
[데이터 다운로드 링크](https://drive.google.com/your-link-here)
